...
function (_Component) {
  ...
  function CreateItem() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "state", {
      ...
      description: '',
      image: '',
      largeImage: '' //if we  use this arrow property, there is no need to bind handleChange to the cirrect this,  it wil be handled
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleChange", function (e) {
      ...
      consolde.log(_this.state.title);
    });
...
//# sourceMappingURL=sell.js.e2711826f961bc01e5bb.hot-update.js.map